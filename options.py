...
flags.DEFINE_boolean('use_normal', True,
                     'Add normal map to the deep buffer.')
flags.DEFINE_boolean('use_wc', True,
                     'Add world coordinate map to the deep buffer.')
